...
ETrF.files <- ETrF.files[grep("_me",ETrF.files)] #uses ETrF images with matching extent. "_me"
...
ETr.files <- paste0("F:/EEFlux/P39R37/",map.year,"/",substr(ET.files,42,52)) #Set your output folder location
